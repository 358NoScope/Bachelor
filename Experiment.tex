...
\captionof{figure}{Häufigkeiten der gemessenen Flugzeiten mit einem \textbf{Wasserjet} in linearer (links) und logarithmischer (rechts) Darstellung. Der dominierende Peak 1 wurde Wasser (H$_2$O$^+$) mit $m$ = 18 u zugeordnet. Peak 2 entspricht OH$^+$. Peak 3 stellt H$^+$ dar. 
