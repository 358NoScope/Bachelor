...
\centering
\includegraphics[width=0.9\textwidth]{../dusenackt.jpg}%
\captionof{figure}{\small Foto der Cluster-Quelle für Flüssigkeiten. Die Heizdrahtwicklungen und Temperaturfühler sind nicht angebracht.}
 \label{fig:dusenackt}
\end{minipage} 
\end{center} 
...
\centering
\includegraphics[width=0.9\textwidth]{../Dusekomplett2.png}%
...
\begin{minipage}{\linewidth}
\centering
\includegraphics[width=0.9\textwidth]{../duseinjetkammer.pdf}%
\captionof{figure}{ Maßstabsgetreue Darstellung der Konfiguration von Skimmer und Cluster-Quelle in der ersten Jetkammer bei 210 mm Haltestangenlänge und eingefahrenem Manipulatorhub (Z = 0 mm).  In Anbetracht der in der Realität 30 mm längeren Haltestangen und 50 mm Hub des Manipulators in Z-Richtung, ist der Kontakt mit dem Skimmer theoretisch möglich. Alle Abmessungen in mm.}
...
\begin{center} 
\begin{minipage}{\linewidth}
\includegraphics[width=0.9\textwidth]{../Spitze2.png}%
 \captionof{figure}{Detailansicht der Spitze. lila: Düsenhalteplatte, pink: Düse, \newline blau: Spitze, gelb: Filter, orange: Filterhalteplatte, schwarz: O-Ring} \label{fig:Spitze2}
\end{minipage} 
\end{center} 
...
\captionof{figure}{\small Foto eines Skimmers aus Kupfer. Der Skimmer ist auf eine verschraubbare Halterung geklebt mit der er in der ersten Jetkammer befestigt wird. Das ermöglicht es den Skimmer zu wechseln, ohne ihn zu beschädigen.}  
 \label{fig:Skimmer}
\end{minipage} 
\end{center} 
...
\captionof{figure}{\small Strahlverlauf bei verschiedenen Entfernungen zum Skimmer. 
...
\captionof{figure}{\small Teststand in Heidelberg. Die Struktur entspricht, bis auf den Quadrupoldetektor in der Hauptkammer, dem Schema in Abbildung \ref{fig:Jetstageaufbau}. }  
 \label{fig:Teststand}
\end{minipage} 
\end{center} 
...
\captionof{figure}{\small Schema eines experimentellen REMI-Ausbaus mit 6 Jetstufen. Die Nummern 1-6 kennzeichnen die Jetstufen. Der Jetstrahl ist als graue gestrichelte Linie gekennzeichnet. Die Skimmer und Schlitze sind in grün bzw. blau angedeutet. In der Hauptkammer des REMI ist der Laserfokus mit einem roten Punkt gekennzeichnet und die Detektoren in türkis markiert. \cite{Sch11}}  
