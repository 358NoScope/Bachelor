...
\captionof{figure}{links: Bild eines Skimmers von Beam Dynamics Inc. \qquad rechts: typische Größenordnung der Abmessungen eines Skimmers. \cite{rausmann2004} \textbf{Bild von echtem Skimmer und Abmessungen nachmessen!}}  
 \label{fig:Skimmer}
\end{minipage} 
\end{center} 
...
\captionof{figure}{ Schema einer experimentellen REMI-Ausbaus mit Jetstufen. Die Nummern 1-6 kennzeichnen die Jetstufen. In der Hauptkammer des REMI ist der Laserfokuspunkt mit einem roten Punkt gekennzeichnet und die Detektoren in türkis angedeutet. Der Jetstrahl ist als graue gestrichelte Linie gekennzeichnet. \cite{Sch11}}  
